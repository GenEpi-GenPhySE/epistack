...
- plotting ANA methylation and ChIP-seq signals at gene promoters 
...
It is therefore possible to arrange panels as you whished, using the
...
The data consists of two H3K27mac ChIP-seq replicates, an input control,
